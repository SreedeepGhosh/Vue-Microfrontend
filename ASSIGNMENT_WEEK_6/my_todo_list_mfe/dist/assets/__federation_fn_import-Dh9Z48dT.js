...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-CADQaCRd.js', import.meta.url).href),import:true},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-Djr6cw4O.js', import.meta.url).href),import:true},'element-plus':{get:()=>()=>__federation_import(new URL('__federation_shared_element-plus-DpligzMF.js', import.meta.url).href),import:true}};
